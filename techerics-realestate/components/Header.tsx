  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-800/80 bg-slate-950/85 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3.5">
        ...
        {/* Navigation Links */}
        <nav className="hidden items-center gap-7 text-xs font-semibold uppercase tracking-wider text-slate-300 md:flex">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-1.5 rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-3.5 py-1.5 text-xs font-semibold text-emerald-400 transition hover:bg-emerald-500/20"
          >
            <span>💬</span> WhatsApp
          </a>
          ...
          <Link
            href="/post-property"
            className="rounded-xl bg-gradient-to-r from-teal-400 to-emerald-400 px-4 py-1.5 text-xs font-bold text-slate-950 shadow-md shadow-teal-500/20 transition hover:opacity-90 active:scale-95"
          >
            {t("postProperty")}
          </Link>
        </div>
