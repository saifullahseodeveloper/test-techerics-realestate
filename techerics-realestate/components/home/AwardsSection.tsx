...
export default function AwardsSection() {
  ...
  const awards = market.awards && market.awards.length
    ? market.awards
    : [
        {
          title: `Best Real Estate Platform in ${market.countryName} 2025`,
          organization: `${market.countryName} PropTech Summit`,
          year: "2025",
        ...
        },
        {
          ...
          organization: "Global PropTech Awards",
          year: "2024",
    ...
    <section className="bg-slate-950 px-4 py-16">
      <div className="mx-auto max-w-6xl text-center">
        <span className="text-xs font-bold uppercase tracking-widest text-teal-400">
          {market.flag} Recognitions & Excellence
        </span>
        <h2 className="mt-1 font-serif text-2xl font-bold text-white sm:text-3xl">
          Awards & Industry Accolades ({market.countryName})
        </h2>
        <p className="mt-1 text-sm text-slate-400">
          Recognized in {market.countryName} for pioneering technology, customer service, and luxury brokerage.
        </p>
