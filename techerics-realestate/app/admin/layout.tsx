          ...
          <aside className="w-64 shrink-0 border-r border-white/10 bg-slate-900/80 backdrop-blur-2xl p-6 hidden md:flex flex-col justify-between">
            <div>
              ...
              <div className="mt-8 space-y-1">
                ...
                <Link
                  href="/admin/dashboard/scraper"
                  className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-xs font-semibold text-emerald-400 bg-emerald-500/10 border border-emerald-500/30 transition hover:bg-emerald-500/20"
                >
                  <span>🔗</span> Whole-Site Bulk Scraper
                </Link>

                <Link
                  href="/admin/dashboard/self-healing"
                  className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-xs font-semibold text-amber-300 bg-amber-500/10 border border-amber-500/30 transition hover:bg-amber-500/20"
                >
                  <span>🛡️</span> AI Self-Healing OS
                </Link>
